...
#4 Escriba un programa en Pandas que devuelva el indice del un elemento dado por el usuario, de 
...
#-Consulte el enlace https://matplotlib.org/stable/plot_types/index.html y explique y dé ejemplos 
#de los gráficos de la sección “basic” que corresponden a scatter(x,y), bar(x, height) y stackplot(x, 
#y).
