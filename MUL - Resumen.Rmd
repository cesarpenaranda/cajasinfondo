...
```{r}
corrgram(base, lower.panel=panel.pts,order=T) #Grafico de las correlaciones normal 
...
#correlaciones a partir del primer valor propio y el primer vector propio
pca1$rotation[,1]*sqrt(eigen(cor(base1))$values[1])
```
