...
# Construct a matrix with 3 rows that contain the numbers 1 up to 9matrix
...
#Si desea consultar el contenido del espacio de trabajo, puede escribir ls()en la consola.
