...
"No corrige sino que modela, tambien se le conoce
como modelos lineales generalizados dobles porque se 
deben definir dos ecuaciones"
...
"si en valor absoluto t value es mayor a 2, se puede decir que 
el coeficiente es significativamente distinto de cero"
...
"*Los minimos cuadrados ponderados, corrigen heterocedasticidad
 *Los modelos heterocedasticos modelan la heterocedasticidad 
 *La regrecion robusta controla valores extremos que podrian generar la heterocedasticidad"